...
export const metadata: Metadata = {
  title: "Interactive ECG Demo — Revant Bisht",
  description:
    "Try the arrhythmia classifier live. Select a condition and see Grad-CAM heatmaps, temporal attention, and a clinical report generated from a real PTB-XL ECG.",
};
    ...
    <main className="bg-navy-900 min-h-screen">
      ...
      <section className="bg-navy-950 border-t border-gray-800 py-16 px-6 text-center">
        <div className="max-w-2xl mx-auto space-y-5">
          <h2 className="text-xl font-bold text-white">Want to understand what just happened?</h2>
          <p className="text-gray-400 text-sm">
            A full technical writeup — dataset, architecture decisions, training
            strategy, and how the explainability layer was built.
          </p>
